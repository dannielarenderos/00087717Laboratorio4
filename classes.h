...
enum parameters {ELEMENT_LENGTH,VAR_T,VAR_K,VAR_Y,VAR_V,VAR_W, VAR_A, VAR_J, VAR_N};
...
class mesh{
    ...
    public:
        ...
        void setParameters(float l,float t,float k,float y,float v,float w,float a,float j,float n){
